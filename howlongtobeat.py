...
#average time played in this dataset vs user time played should do it instead of this ^ (bcs more than 30% of games in my dataset are missing on this page + it has different formating)
...
average_time_played = pd.read_csv("Datasets/game_indexes.csv")
average_time_played.to_csv(f"Datasets/average_time_play_full.csv")